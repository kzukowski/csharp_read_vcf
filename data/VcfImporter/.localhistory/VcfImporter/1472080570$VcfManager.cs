...
namespace VcfImporter
{
    class VcfManager
    {
        ...
        public void sendQueriesInTransaction(List<string> queries)
        {
        ...
        public List<string> tableInsertQueryStringGenerator(string tableLocationAndName, int divideEveryColumn)//when database is too large it is necessary to send database in multiple packets
        {
